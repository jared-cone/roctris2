...
# taken from https://github.com/lukewilliamboswell/basic-ssg/blob/main/build.roc
...
## Builds the roctris[platform](https://www.roc-lang.org/platforms).
##
## run with: roc ./platform/main-build.roc --release
##
main : Task {} _
main =
    cliParser =
        ...
        |> Arg.Cli.finish {
            name: "roctris-builder",
            version: "",
            authors: ["Jared Cone <https://github.com/jared-cone>"],
            description: "Generates all files needed by Roc to use this platform.",
        }
        |> Arg.Cli.assertValid
...
run = \{ release, bundle, maybeRoc } ->
    ...
    # TODO move functionality from sh file to here
    "./glue-gen.sh"
        |> Cmd.exec []
